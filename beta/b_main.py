...
from editing_b import make_edits
from script_b import generate_script2
from voice_b import compile_audio
from captions_b import build_mrbeast_captions
from thumbnail_b import generate_thumbnail
#from upload_yt import upload_youtube
from upload_b import upload_youtube2 #<---- v2 for channel specific upload. .json must be in yt_apis folder
...
DESCRIPTION = "\n".join([
    ...
    "characters and sharp pacing. Names, details, and time.ines are changed. These are our own scripts, "
